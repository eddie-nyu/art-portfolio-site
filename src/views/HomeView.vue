...
<template>
  <main>
    ...
    <section>
      <figure class="image is-16x9">
        <img src="@/assets/uyu_collage.jpg">
      </figure>
    </section>
    ...
    <section>
      <figure class="image is-16x9">
        <img src="@/assets/uyu_logo_collage.jpg">
      </figure>
    </section>
    <section>
      <br />
    ...
    <section style="margin: 1rem 1rem;">
      <div class="columns is-mobile">
        <div class="column">
          <article>
            <figure class="image">
              <img src="@/assets/Wallpaper_1.jpg">
            </figure>
          </article>
        </div>
        <div class="column">
          <article>
            <figure class="image">
              <img src="@/assets/Wallpaper_2.jpg">
            </figure>
          </article>
        </div>
        <div class="column">
          <article>
            <figure class="image">
              <img src="@/assets/Wallpaper_3.jpg">
            </figure>
          </article>
        </div>
      </div>
    ...
    <section>
      <figure class="image is-16x9">
        <img src="@/assets/UYU_Addidas_test_kami.jpg">
      </figure>
    </section>
  </main>
</template>
