...
var piniaSymbol = false ? Symbol("pinia") : Symbol();
...
var USE_DEVTOOLS = typeof __VUE_PROD_DEVTOOLS__ !== "undefined" && __VUE_PROD_DEVTOOLS__ && true && IS_CLIENT;
...
var skipHydrateSymbol = false ? Symbol("pinia:skipHydration") : Symbol();
...
function createOptionsStore(id, options, pinia, hot) {
  ...
  function setup() {
    ...
    const localState = false ? toRefs(ref(state ? state() : {}).value) : toRefs(pinia.state.value[id]);
